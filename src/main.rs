...
fn main() -> Result<(), std::io::Error> {
    ...
    for color in sorted_colors.into_iter() {
        ...
        if alpha == 255 {
            ...
            write!(fsvg, "<path ")?;
            if ids {
                write!(fsvg, "id=\"{}_{}_{}_{}\" ", red, green, blue, OP[alpha])?;
            }
            write!(fsvg, "fill=\"rgb({},{},{})\" opacity=\"{}\" d=\"", red, green, blue, OP[alpha])?;
        }
